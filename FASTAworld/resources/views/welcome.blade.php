...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="flex min-h-full flex-col justify-center  px-6 py-12 lg:px-8 w-full max-w-md bg-white rounded-lg shadow-md">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="text-center text-3xl font-bold tracking-tight text-gray-900">FASTAworld</h2>
            <p class="mt-2 text-center text-sm text-gray-600">
                Choose an option below
            </p>
        </div>
        <div class="mt-8 space-y-4">
            <x-button id="loginBtn" class="bg-indigo-600 text-white hover:bg-indigo-500 focus:ring-indigo-500">
                {{ __('Log in') }}
            </x-button>
            <x-button id="registerBtn" class="bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-400">
                {{ __('Register') }}
            </x-button> 
        </div>

        <!-- Login Section -->
        <div id="loginSection" class="hidden mt-6">
            ...
            <form  method="POST" action="{{ route('login') }}" class="mt-4 space-y-4">
                ...
                <div>
                    <x-button id="log-in-submit-button" class="bg-indigo-600 text-white hover:bg-indigo-500 focus:ring-indigo-500">
                        {{__('Submit')}}
                    </x-button>
                </div>
            </form>
        ...
        <div id="registerSection" class="hidden mt-6">
            ...
            <form method="POST" action="{{ route('register') }}" class="mt-4 space-y-4">
                ...
                <div>
                    ...
                    <x-text-input id="email_register" type="email" name="email_register"  :value="old('email_register')" required autocomplete="email_register" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="password_register_confirmation"
                                    type="password"
                ...
                <div>
                    <x-button id="register-submit-button" class="bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-400">
                        {{__('Register')}}
                    </x-button>
                </div>
            </form>
